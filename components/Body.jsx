...
const Body = () => {
  ...
  return (
    <div className='w-full px-10'>
      <h2 className='font-semibold font-outfit text-sm text-gray-sub pb-5'>DESCRIPTION</h2>
      <p className={text}>
      Bidesh Beacon is a map application designed to assist South Asian newcomers 
      ...
      maps, finding a route between two locations, and switching the UI to night mode.
      <br/>
      </p>
      ...
      <p className={text}>
      <br/>The application was written in C++, using the GTK library for the user interface, 
      ...
      between two points, taking into account speed limits.

      <br/><br/>As a team of South Asian developers who were once newcomers ourselves, we understood 
      ...
      <br/><br/>This project was created for the UofT Software Design course ECE297, in which we 
      ...
      there for us to expand the service in the future.

      <br/><br/>Although the product has room for improvement, I believe what we achieved in the time 
      frame we were given shows our passion and commitment towards our mission and our community.
      </p>
    </div>
  )
}
